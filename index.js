document.addEventListener("DOMContentLoaded", () => {
  ...
  function fetchCharacters(name) {
    ...
    //check the docs regex so it makes it case insensitive
  ...
  function renderNameCard(data) {
    ...
    listContainer.append(btnDelete, characNameList, characRace, characGender, characSpouse, characBirth, characDeath, wikiLi, quoteBtn, quoteh4);
...
//     document.querySelector("#listContainer").prepend(btn)
// }
